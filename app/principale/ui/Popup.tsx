        ...
        <div className="flex flex-col grow overflow-hidden pr-3">
          ...
          <div className="grid grid-cols-4 gap-2">
            <div className="flex flex-col">
              ...
              <span className="text-xs font-semibold text-neutral-800">{sommet.altitude ? `${sommet.altitude}m` : '-'}</span>
            </div>
            <div className="flex flex-col">
            ...
            <div className="flex flex-col overflow-hidden">
              ...
              <span className="text-xs font-semibold text-neutral-800 truncate w-full" title={sommet.pays}>{sommet.pays || '-'}</span>
            </div>
          </div>
        </div>
      </div>
